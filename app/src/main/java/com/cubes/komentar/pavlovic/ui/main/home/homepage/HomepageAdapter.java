...
import com.cubes.komentar.pavlovic.data.response.responsehomepage.ResponseHomePageDataCategoryBox;
...
public class HomepageAdapter extends RecyclerView.Adapter<HomepageAdapter.HomepageViewHolder> {
    ...
    public ArrayList<ResponseHomePageDataCategoryBox> dataBox;
    private Context context;
    private ArrayList<RecyclerViewItemHomepage> items;
    private ArrayList<News> news;

    public HomepageAdapter(ResponseHomepageData data,Context context) {
        this.data = data;
        ...
        //7-8
        for (ResponseHomePageDataCategoryBox categoryBox : dataBox){
